            ...
            <div className="gm-apps-dropdown">
              <div className="gm-apps-columns-container">
                ...
                <div className="gm-apps-column">
                  ...
                  <div className="gm-app-item" onClick={() => { navigate('/employee/main/analytics-hub'); setShowAppsMenu(false); }}>
                  ...
                  <div className="gm-app-item" onClick={() => { navigate('/employee/information/employee-profile'); setShowAppsMenu(false); }}>
